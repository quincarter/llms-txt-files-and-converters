...
The `.gemini/agents` directory contains specialized agent instruction files for different roles and tasks, such as frontend development, UI design, code review, and testing automation.

**How AI Should Use These Agents:**

1. **Select the Appropriate Agent:**
    - Choose the agent file that best matches the required role or task (e.g., `ui-designer.md`, `code-reviewer.md`).
...
> "For a new web component, use the main instructions to plan the schema and tests. Then, delegate UI implementation to the `ui-designer.md` agent, and code review to the `code-reviewer.md` agent. Integrate their outputs and ensure all requirements are met."
